...
export const ENTERPRISE_SENSITIVE_ACTION_IDS = [
  ...
  "renewal_decision",
  "renewal_workspace_view",
  "renewal_decision_management",
  "renewal_scenario_management",
  "renewal_task_management",
  "renewal_evidence_review",
  "renewal_decision_approval",
  "renewal_financial_outcome_confirmation",
  "renewal_negotiation_draft_management",
  "renewal_proposal_upload",
  "renewal_comparison_run",
  "renewal_negotiation_position_approval",
  "renewal_negotiation_pack_export",
  "cycle_close_reopen",
  "export_basic",
...
> = {
  ...
  renewal_workspace_view: shippedRule({
    id: "renewal_workspace_view",
    label: "Renewal workspace view",
    action: "view_renewal_workspace",
    minimumPlanOrGate: "starter",
    ownerSurfaces: ["/dashboard/renewal-workspace", "lib/renewal-workspace"],
    requiredTestsOrReleaseGates: ["test:renewal-workspace", "tests/permissions.test.ts"],
    notes: "Workspace visibility remains active-organization scoped and does not grant mutation authority."
  }),
  renewal_decision_management: shippedRule({
    id: "renewal_decision_management",
    label: "Renewal decision management",
    action: "manage_renewal_decision",
    minimumPlanOrGate: "starter",
    ownerSurfaces: ["lib/actions/commercial-decision-workbench.ts", "lib/actions/renewal-workspace.ts"],
    requiredTestsOrReleaseGates: ["test:commercial-decision-workbench", "tests/commercial-decision-actions.test.ts"],
    notes: "Commercial decision changes require explicit renewal authority in addition to tenant scope."
  }),
  renewal_scenario_management: shippedRule({
    id: "renewal_scenario_management",
    label: "Renewal scenario management",
    action: "manage_renewal_scenarios",
    minimumPlanOrGate: "starter",
    ownerSurfaces: ["lib/actions/renewal-workspace.ts", "lib/actions/contracts/quote-comparison.ts"],
    requiredTestsOrReleaseGates: ["test:renewal-workspace", "test:renewal-quote-comparison"],
    notes: "Scenario and quote comparison changes are separated from general contract review."
  }),
  renewal_task_management: shippedRule({
    id: "renewal_task_management",
    label: "Renewal task management",
    action: "manage_renewal_tasks",
    minimumPlanOrGate: "starter",
    ownerSurfaces: ["lib/actions/renewal-workspace.ts"],
    requiredTestsOrReleaseGates: ["test:renewal-workspace", "tests/renewal-workspace.test.ts"],
    notes: "Reviewer task completion remains assignment-scoped even when the base capability is present."
  }),
  renewal_evidence_review: shippedRule({
    id: "renewal_evidence_review",
    label: "Renewal evidence review",
    action: "review_renewal_evidence",
    minimumPlanOrGate: "starter",
    ownerSurfaces: ["lib/actions/subscription-usage-optimization.ts", "lib/actions/contracts/quote-comparison.ts"],
    requiredTestsOrReleaseGates: ["test:evidence-readiness", "test:renewal-quote-comparison"],
    notes: "Evidence review does not imply authority to approve a decision or confirm financial value."
  }),
  renewal_decision_approval: shippedRule({
    id: "renewal_decision_approval",
    label: "Renewal decision approval",
    action: "approve_renewal_decision",
    minimumPlanOrGate: "starter",
    ownerSurfaces: ["lib/actions/renewal-workspace.ts"],
    requiredTestsOrReleaseGates: ["test:renewal-workspace", "tests/commercial-decision-service.test.ts"],
    notes: "Approval also requires assignment and separation-of-duties checks."
  }),
  renewal_financial_outcome_confirmation: shippedRule({
    id: "renewal_financial_outcome_confirmation",
    label: "Renewal financial outcome confirmation",
    action: "confirm_financial_outcome",
    minimumPlanOrGate: "starter",
    ownerSurfaces: ["lib/actions/renewal-workspace.ts"],
    requiredTestsOrReleaseGates: ["test:renewal-workspace", "tests/renewal-workspace.test.ts"],
    notes: "Realized savings require explicit authority and customer-confirmed outcome evidence."
  }),
  renewal_negotiation_draft_management: shippedRule({
    id: "renewal_negotiation_draft_management",
    label: "Renewal negotiation draft management",
    action: "manage_negotiation_drafts",
    minimumPlanOrGate: "starter",
    ownerSurfaces: ["lib/actions/negotiation-workflow.ts"],
    requiredTestsOrReleaseGates: ["test:negotiation-workflow", "tests/negotiation-workflow-actions.test.ts"],
    notes: "Draft management remains copy-only and cannot send vendor communications."
  }),
  renewal_proposal_upload: shippedRule({
    id: "renewal_proposal_upload",
    label: "Renewal proposal upload",
    action: "upload_renewal_proposal",
    minimumPlanOrGate: "starter",
    ownerSurfaces: ["lib/actions/contracts/quote-comparison.ts", "components/contracts/renewal-quote-comparison-panel.tsx"],
    requiredTestsOrReleaseGates: ["test:renewal-quote-comparison", "tests/quote-comparison-actions.test.ts"],
    notes: "Proposal intake is scoped separately from contract intake and never updates the reviewed baseline."
  }),
  renewal_comparison_run: shippedRule({
    id: "renewal_comparison_run",
    label: "Commercial comparison execution",
    action: "run_commercial_comparison",
    minimumPlanOrGate: "starter",
    ownerSurfaces: ["lib/quote-comparison/commercial-comparison-engine.ts", "lib/actions/contracts/quote-comparison.ts"],
    requiredTestsOrReleaseGates: ["test:renewal-quote-comparison", "tests/commercial-comparison-engine.test.ts"],
    notes: "Deterministic comparison is separate from proposal review and commercial approval."
  }),
  renewal_negotiation_position_approval: shippedRule({
    id: "renewal_negotiation_position_approval",
    label: "Negotiation position approval",
    action: "approve_negotiation_position",
    minimumPlanOrGate: "starter",
    ownerSurfaces: ["lib/quote-comparison/commercial-comparison-engine.ts"],
    requiredTestsOrReleaseGates: ["test:renewal-quote-comparison", "tests/commercial-comparison-engine.test.ts"],
    notes: "Approved positions require admin/owner authority and are invalidated by material evidence changes."
  }),
  renewal_negotiation_pack_export: shippedRule({
    id: "renewal_negotiation_pack_export",
    label: "Negotiation pack export",
    action: "export_negotiation_pack",
    minimumPlanOrGate: "starter",
    ownerSurfaces: ["lib/quote-comparison/commercial-comparison-engine.ts"],
    requiredTestsOrReleaseGates: ["test:renewal-quote-comparison", "tests/commercial-comparison-engine.test.ts"],
    notes: "Export is permission-gated and limited to safe reviewed evidence and deterministic calculations."
  }),
