  ...
  public: {
    Tables: {
      ...
      evidence_readiness_history: {
        Row: { id: string; assessment_id: string; organization_id: string; contract_id: string; decision_profile: string; score: number; readiness_state: string; calculation_version: string; evidence_hash: string; critical_blocker_count: number; missing_count: number; stale_count: number; conflicting_count: number; changed_requirement_keys: string[]; item_snapshot: Json; calculated_at: string; created_at: string };
        Insert: { id?: string; assessment_id: string; organization_id: string; contract_id: string; decision_profile: string; score: number; readiness_state: string; calculation_version: string; evidence_hash: string; critical_blocker_count?: number; missing_count?: number; stale_count?: number; conflicting_count?: number; changed_requirement_keys?: string[]; item_snapshot?: Json; calculated_at: string; created_at?: string };
