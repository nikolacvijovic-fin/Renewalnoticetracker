  ...
  public: {
    Tables: {
      ...
      subscription_usage_sync_runs: {
        Row: { id: string; organization_id: string; provider_connection_id: string; provider: string; status: string; idempotency_key: string; logical_interval_key: string | null; attempt_number: number; previous_attempt_id: string | null; retry_after: string | null; usage_import_batch_id: string | null; started_at: string | null; completed_at: string | null; failed_at: string | null; duration_ms: number | null; row_count: number; finding_count: number; retry_count: number; provider_error_category: string | null; last_error_code: string | null; cursor_checkpoint: string | null; metadata: Json; created_at: string; updated_at: string };
        Insert: { id?: string; organization_id: string; provider_connection_id: string; provider: string; status?: string; idempotency_key: string; logical_interval_key?: string | null; attempt_number?: number; previous_attempt_id?: string | null; retry_after?: string | null; usage_import_batch_id?: string | null; started_at?: string | null; completed_at?: string | null; failed_at?: string | null; duration_ms?: number | null; row_count?: number; finding_count?: number; retry_count?: number; provider_error_category?: string | null; last_error_code?: string | null; cursor_checkpoint?: string | null; metadata?: Json; created_at?: string; updated_at?: string };
