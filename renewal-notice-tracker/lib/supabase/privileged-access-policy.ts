export const APPROVED_DIRECT_ADMIN_SUPABASE_IMPORTERS = [
  ...
  "lib/evidence-readiness/repositories/admin-evidence-readiness-repository.ts",
  ...
  "lib/renewal-workspace/repositories/admin-renewal-workspace-repository.ts",
  ...
  "lib/subscription-usage/repositories/admin-scheduled-sync-repository.ts",
