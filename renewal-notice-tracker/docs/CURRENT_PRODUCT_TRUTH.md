...
Gated intelligence, financial exposure, procurement analytics, the Revenue Intelligence Command Center, exports, OCR/import, reminders, billing, and internal operations may ship only as renewal-control modules classified in the registry. The command center is aggregation/reporting over existing renewal-control evidence; external outreach delivery, lead generation, CRM enrichment, broad integrations, advanced analytics, and full CLM remain deferred, experimental, or excluded until the registry and release gates explicitly promote them.
