...
| `subscription_usage_optimization` | experimental | no | Growth gate, signed Microsoft 365 / Google Workspace retrieval, Python reconciliation health, review-only findings, and CSV/XLSX fallback | connector boundary tests, import/workflow tests, Python reconciliation tests, Java mocked-provider tests, future promotion gate |
